...
document.addEventListener("DOMContentLoaded", function() {
    // Llamar a la función guardaHorario después de que el DOM esté listo
    guardaHorario();
    // Llamar a la función dT después de que el DOM esté listo
    dT();
});
$(document).ready(function() {
    dT(); // Llama a la función dT() cuando el DOM esté listo
});
...
function dT() {
    ...
    // Verificar si el elemento de tiempo existe antes de actualizar su contenido
    if (time) {
        time.innerHTML = t;
    }
}
